...
\* Current enters saturation beyond (V\_{DS} = V\_{GS} - V\_{TH})
...
NMOS and PMOS widths were calculated analytically to achieve balanced rise/fall delays and an inverter threshold near (V\_{DD}/2).
